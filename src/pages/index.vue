<template>
  <div>
    <section class="main-section">
      <img src="../assets/imgs/main-img-1.png" alt="" felimotion="top"/>
      <div felimotion="appearance">
        <h1 class="text-center" >MAROON</h1>
        <p class="text-center">Натуральная косметика <br />для бережного ухода за кожей</p>
        <FButton class="m-auto" path="/catalog">Подробнее</FButton>
      </div>
      <img src="../assets/imgs/main-img-2.png" alt="" felimotion="top" />
    </section>
    <SeasonalProduct />
    <section class="individual container">
      ...
      <img src="../assets/imgs/individual-img.png" alt="" felimotion="appearance" />
    </section>
